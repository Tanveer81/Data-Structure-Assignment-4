...
void Graph::setnVertices(int n)
{
	...
	distList = new ArrayList[nVertices];
}
...
void Graph::addEdge(int u, int v, int w)
{
	...
	distList[u].insertItem(w);
	if(!directed){
    adjList[v].insertItem(u) ;
    distList[v].insertItem(w) ;
	}
}
...
void Graph::removeEdge(int u, int v)
{
    ...
    distList[u].removeItemAt(i);
    if(!directed) {
        int j=adjList[v].searchItem(u);
        adjList[v].removeItem(u) ;
        distList[v].removeItemAt(j);
    }
